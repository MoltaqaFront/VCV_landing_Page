        ...
        <div class="row align-items-center justify-content-between">
          ...
          <div class="col-lg-6" data-aos-once="true" :data-aos="$i18n.locale == 'ar' ? 'fade-left' : 'fade-right'"
            ...
            <div class="section_text_wrapper">
              ...
              <div class="download_btns_wrapper">
                <a href="https://apps.apple.com/us/app/vcv/id1562848455?ls=1" target="_blank">
                  <img src="~/assets/media/stores/apple-store.svg" alt="apple store" loading="lazy" />
                </a>

                <a href="https://play.google.com/store/apps/details?id=com.vcv.moltaqa" target="_blank">
          ...
          <div class="col-lg-5">
            <div class="section_image_wrapper">
              ...
              <img class="screen" src="~/assets/media/images/mobileScreens/Mockup-VCV.png" alt="download_screen"
